...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	scheduledGroupTestPlanRepository := repository.NewScheduledGroupTestPlanRepository(db)
	scheduledGroupTestService := service.ProvideScheduledGroupTestService(scheduledGroupTestPlanRepository)
	scheduledGroupTestHandler := admin.NewScheduledGroupTestHandler(scheduledGroupTestService)
	...
	scheduledGroupTestRunnerService := service.ProvideScheduledGroupTestRunnerService(scheduledGroupTestPlanRepository, accountRepository, accountTestService, configConfig)
	paymentOrderExpiryService := service.ProvidePaymentOrderExpiryService(paymentService, leaderLockCache, db)
	channelMonitorRunner := service.ProvideChannelMonitorRunner(channelMonitorService, settingService)
	userPlatformQuotaUsageFlusher := service.ProvideUserPlatformQuotaUsageFlusher(configConfig, billingCache, serviceUserPlatformQuotaRepository, timingWheelService)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, schedulerSnapshotService, tokenRefreshService, accountExpiryService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, scheduledGroupTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, userPlatformQuotaUsageFlusher)

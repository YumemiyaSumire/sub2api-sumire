export default {
  ...
  admin: {
    ...
    oauthSleeper: {
      ...
      saved: 'OAuth 休眠设置已保存',
      settingsTitle: '休眠设置',
      settingsHint: '默认关闭；启用后在用量快照达到阈值时自动休眠 active OAuth 账号。',
      enabled: '启用 OAuth 休眠',
      enabledHint: 'OpenAI / Anthropic 用量快照达到阈值后，会自动写入账号休眠限流。',
      threshold: '触发阈值 (%)',
      thresholdHint: '范围 1 - 100；OpenAI 使用百分比，Anthropic fraction 会换算成百分比。',
      platformScope: '保护平台',
      groupScopeHint: '启用后只保护这里选中的 OpenAI / Anthropic 分组；不选择分组不会保护整个平台。',
    ...
    accounts: {
      ...
      batchTestTitle: '批量测试账号连接',
      batchTestGroup: '分组',
      batchTestGroupPlaceholder: '选择要测试的分组',
      batchTestNoGroups: '暂无可选分组',
      batchTestModel: '模型 ID',
      batchTestModelPlaceholder: '例如 gpt-5.4-mini',
      batchTestModelPresets: '常用测试模型',
      batchTestStart: '开始测试',
      batchTesting: '测试中...',
      batchTestDone: '测试完成',
      batchTestEmptyGroup: '该分组下暂无账号。',
      batchTestFailed: '批量测试失败',
      batchTestTotal: '总数',
      batchTestSuccess: '成功',
      batchTestFailedCount: '失败',
      batchTestStatusSuccess: '成功',
      batchTestStatusFailed: '失败',
      batchTestErrorDetails: '失败详情',
      batchTestResponseText: '响应内容',
      account: '账号',

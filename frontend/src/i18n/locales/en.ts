export default {
  ...
  admin: {
    ...
    oauthSleeper: {
      title: 'OAuth Sleeper',
      description: 'Automatically rate-limit OAuth accounts that are near recorded usage-window resets',
      loadFailed: 'Failed to load OAuth Sleeper',
      saveFailed: 'Failed to save OAuth Sleeper settings',
      eventsFailed: 'Failed to load sleeper events',
      scanFailed: 'Manual scan failed',
      saved: 'OAuth Sleeper settings saved',
      scanSuccess: 'Scan completed; {triggered} account(s) were put to sleep',
      settingsTitle: 'Sleeper Settings',
      settingsHint: 'Disabled by default. When enabled, scans active OAuth accounts and writes rate-limit resets through the account repository.',
      enabled: 'Enable OAuth Sleeper',
      enabledHint: 'Periodically scan OpenAI / Anthropic OAuth accounts close to the usage threshold.',
      threshold: 'Trigger Threshold (%)',
      thresholdHint: 'Range 1 - 100. OpenAI uses percentages; Anthropic fractions are converted to percentages.',
      scanInterval: 'Scan Interval (seconds)',
      intervalHint: 'Range 30 - 86400 seconds.',
      maxSleepPerScan: 'Max New Sleeps Per Group',
      maxSleepHint: 'Range 1 - 100. Limits newly sleeping accounts per scan for each selected group.',
      platformScope: 'Platforms',
      groupScopeHint: 'When enabled, only the selected OpenAI / Anthropic groups are scanned; an empty group selection never scans the whole platform.',
      defaultThreshold: 'Default Trigger Threshold (%)',
      groupThresholds: 'Group Threshold Overrides',
      groupThresholdsHint: 'Leave a group blank to use the default threshold. Accounts in multiple selected groups use the lowest threshold.',
      saveSettings: 'Save Settings',
      scanOnce: 'Scan Once',
      scanning: 'Scanning...',
      running: 'Running',
      paused: 'Paused',
      lastError: 'Last scan error: {error}',
      platformRequired: 'Enable at least one platform',
      groupRequired: 'Select at least one group before enabling OAuth Sleeper',
      noPlatformEnabled: 'No platform enabled',
      noGroupSelected: 'No group selected',
      groupScopeMeta: '{names} and {count} groups',
      intervalMeta: 'Every {seconds}s',
      effectiveIntervalMeta: 'Configured {configured}s, effective {effective}s',
      effectiveIntervalAcceleratedMeta: 'Configured {configured}s, accelerated to {effective}s',
      accelerated: 'Accelerated',
      acceleratedNoticeTitle: 'Smart acceleration active',
      acceleratedUntilMeta: '{names} are scanning faster until {time}',
      acceleratedGroupScopeMeta: '{names} and {count} groups',
      lastScanMeta: 'Scanned {scanned}, triggered {triggered}',
      maxPerGroupMeta: 'Adds up to {count} per group per scan',
      sleepingAccounts: 'Sleeping Accounts',
      sleepingAccountsHint: 'Shows OpenAI / Anthropic OAuth accounts whose rate_limit_reset_at is still in the future.',
      sleepingCount: '{count} sleeping',
      noSleepingAccounts: 'No OAuth accounts are sleeping',
      eventsTitle: 'Sleeper Events',
      eventsHint: 'Events are recorded only after the account rate-limit reset is successfully written.',
      noEvents: 'No sleeper events',
      unnamedAccount: 'Unnamed account',
      scanResult: 'Last manual scan: scanned {scanned} accounts, triggered {triggered} sleeper events.',
      thresholdMeta: 'Threshold {threshold}',
      ...
      windows: {
        ...
        passive_usage_7d: 'Passive Usage 7d',
      },
    },
    ...
    accounts: {
      ...
      searchAccounts: 'Search accounts or email...',
      notes: 'Notes',

export default {
  ...
  admin: {
    ...
    oauthSleeper: {
      ...
      settingsHint: 'Disabled by default. When enabled, usage snapshots automatically put active OAuth accounts to sleep once they reach the threshold.',
      enabled: 'Enable OAuth Sleeper',
      enabledHint: 'OpenAI / Anthropic usage snapshots write account sleep limits automatically after reaching the threshold.',
      threshold: 'Trigger Threshold (%)',
      thresholdHint: 'Range 1 - 100. OpenAI uses percentages; Anthropic fractions are converted to percentages.',
      platformScope: 'Protected Platforms',
      groupScopeHint: 'When enabled, only the selected OpenAI / Anthropic groups are protected; an empty group selection never protects the whole platform.',
      ...
      running: 'Running',
      paused: 'Paused',
      lastError: 'Last automatic check error: {error}',
      platformRequired: 'Enable at least one protected platform',
      ...
      lastScanMeta: 'Checked {scanned}, triggered {triggered}',
    ...
    accounts: {
      ...
      batchTestTitle: 'Batch Test Account Connections',
      batchTestGroup: 'Group',
      batchTestGroupPlaceholder: 'Select a group to test',
      batchTestNoGroups: 'No groups available',
      batchTestModel: 'Model ID',
      batchTestModelPlaceholder: 'e.g. gpt-5.4-mini',
      batchTestModelPresets: 'Common test models',
      batchTestStart: 'Start Test',
      batchTesting: 'Testing...',
      batchTestDone: 'Test complete',
      batchTestEmptyGroup: 'This group has no accounts.',
      batchTestFailed: 'Batch test failed',
      batchTestTotal: 'Total',
      batchTestSuccess: 'Success',
      batchTestFailedCount: 'Failed',
      batchTestStatusSuccess: 'Success',
      batchTestStatusFailed: 'Failed',
      batchTestErrorDetails: 'Error Details',
      batchTestResponseText: 'Response Text',
      account: 'Account',

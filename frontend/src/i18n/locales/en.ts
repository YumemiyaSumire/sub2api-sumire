export default {
  ...
  admin: {
    ...
    oauthSleeper: {
      ...
      maxSleepPerScan: 'Max New Sleeps Per Scan',
      maxSleepHint: 'Range 1 - 100. Limits newly sleeping accounts per scan; OpenAI and Anthropic are capped separately.',
      ...
      maxPerPlatformMeta: 'Adds up to {count} per platform per scan',
